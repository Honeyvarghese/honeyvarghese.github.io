...
public class AnalyzeSkeleton_ implements PlugInFilter, DialogListener
{
	...
	public void run(ImageProcessor ip) 
	{
		...
		//gd.addMessage("Elimination of End-points:", headerFont, null);
		...
		//gd.addMessage("Results and Output:", headerFont, null);
		...
		//((GenericDialog) gd).addHelp("http://fiji.sc/AnalyzeSkeleton");
	...
	void displayTagImage(ImageStack taggedImage)
	{
		...
		//IJ.resetMinAndMax();
	//	((ImagePlus) tagIP).resetDisplayRange();
		tagIP.updateAndDraw();
